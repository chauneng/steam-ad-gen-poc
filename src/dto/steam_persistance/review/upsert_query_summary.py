...
class UpsertReviewQuerySummaryDTO(BaseModel):
    ...
    id: Optional[int] = Field(None, description="Review Query Summary ID")
    game_id: int = Field(..., description="Game ID")
    num_reviews: Optional[int] = Field(None, description="Total number of reviews")
    review_score: Optional[float] = Field(None, description="Overall review score")
